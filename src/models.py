...
class User(db.Model):
    ...
    username: Mapped[str] = mapped_column(String(60), unique=False, nullable=False)
    firstname: Mapped[str] = mapped_column(String(60), unique=False, nullable=False)
    lastname: Mapped[str] = mapped_column(String(60), unique=False, nullable=False)
